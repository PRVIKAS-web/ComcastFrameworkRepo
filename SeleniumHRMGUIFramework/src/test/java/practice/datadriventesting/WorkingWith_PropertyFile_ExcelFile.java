...
public class WorkingWith_PropertyFile_ExcelFile {
	...
	public static void main(String[] args) throws IOException 
	{
	      ...
	      //Generate random number
	       ...
	       //read data from excelfile
			...
			String fn=sheet.getRow(1).getCell(0).toString()+randomInt;
			String mn=sheet.getRow(1).getCell(1).toString();
			String ln=sheet.getRow(1).getCell(2).toString();
			String id=sheet.getRow(1).getCell(3).toString();
